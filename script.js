        ...
        const githubProjects = [
            {
                id: "shingaku",
                name: "Shingaku",
                description: "Award-winning AI-driven educational platform recognized by Google Deepmind and Elevenlabs. Features real-time translation and voice synthesis.",
                language: "Python",
                stars: 1,
                updated: "2026-03-20",
                homepage: "",
                html_url: "https://github.com/Nirusaki-Malaal/Shingaku",
                color: "neon-cyan",
                gradient: "linear-gradient(135deg, #00f5ff 0%, #b026ff 100%)",
                details_url: "/projects/shingaku.html"
            },
            {
                id: "video-encoder",
                name: "video-encoder",
